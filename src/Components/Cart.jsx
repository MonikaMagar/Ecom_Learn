  ...
  if (cart.length === 0) {
    return (
      <div className="text-center my-5">
        <div className="border border-2 bg-white rounded-4 p-5">
          <img src="https://m.media-amazon.com/images/G/31/cart/empty/kettle-desaturated._CB424694257_.svg" style={{width:'30%'}} alt="" />
          <h1 className="fw-bold text-danger">
          Your StyleSnap Cart is empty</h1>

          <p className="display-4">Shop today’s deals</p>
          <Link to="/">
