...
const Navigation = ({ searchTerm, setSearchTerm }) => {
    ...
    return (
        <>
            <Navbar expand="lg" className="navbar-custom shadow-sm sticky-top">
                <Container fluid>
                    <Link className="navbar-brand" style={{fontStyle:"inherit"}} to="/">StyleSnap</Link>
                    <Nav.Link style={{fontSize:'20px', color:'white'}}  as={Link} to="/">Home</Nav.Link>
    ...
    <FaHeart className="wishlist-icon" />  ({wishlist.length})
</Nav.Link>
